...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=L3pQgAAQ#e-jZ95SdUylFoxGuZb04USDBEwteLHRAR94mjvLBSso' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '$' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , Bezel music bot is currently online and running!!*" : process.env.ALIVE_MSG,
